...
import ConfirmBitcoinPath from "./bitcoin/confirmBitcoinPath";
import { ConfirmLightningPath } from "./lightning/confirmLightningPath";
import { ManualAddressInput } from "./manualAddressInput";

export default function CameraScan(props) {
  ...
  return (
    <View
      style={{
        ...
        top: props.isCameraActive ? 50 : "120%",
      }}
    >
